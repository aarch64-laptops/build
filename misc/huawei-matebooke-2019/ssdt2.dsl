 ...
 */
DefinitionBlock ("", "SSDT", 4, "HUAWEI", "SSDT2Tbl", 0x00000003)
{
    External (_SB_.ECOK, IntObj)
    External (_SB_.GIO0.FSTA, FieldUnitObj)
    External (_SB_.GIO0.PS18, FieldUnitObj)
    External (_SB_.GIO0.PS7C, FieldUnitObj)
    External (_SB_.I2C8.ERSE, MethodObj)    // 1 Arguments
    External (_SB_.I2C8.NREP, MethodObj)    // 2 Arguments
    External (_SB_.I2C8.NWEP, MethodObj)    // 3 Arguments
    External (_SB_.I2C8.RESP, MethodObj)    // 2 Arguments
    External (_SB_.I2C8.WEEP, MethodObj)    // 3 Arguments
    External (_SB_.I2C8.WRSP, MethodObj)    // 3 Arguments
    External (_SB_.MUT0, MutexObj)
    External (_SB_.MUTX, MutexObj)
    External (CPUN, FieldUnitObj)
    External (FUSE, FieldUnitObj)
    External (PROD, FieldUnitObj)
    External (RPMB, FieldUnitObj)
    ...
    Scope (\_SB)
    {
        Device (WMI1)
        {
                ...
                If ((Arg0 == BLK0))
                {
                    If (CondRefOf (\_SB.I2C8.NREP))
                    {
                        ...
                        While ((Local0 < 0x04))
                        {
                            ...
                            WRTB = \_SB.I2C8.NREP (Local1, 0x40)
                            While ((Local2 < 0x40))
                            {
            ...
            Method (WMA4, 3, Serialized)
            {
                ...
                {
                    Local0 = \_SB.I2C8.NREP (Local1, 0x10)
            ...
            Method (WMA6, 3, Serialized)
            {
                ...
                {
                    Local0 = \_SB.I2C8.RESP (Local1, Local3)
