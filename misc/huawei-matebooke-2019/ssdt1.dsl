 ...
 *
 * Disassembly of ssdt1.dat, Thu Aug 27 00:11:44 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000036DC (14044)
 *     Revision         0x03
 *     Checksum         0x48
 *     OEM ID           "HUAWEI"
...
{
    External (_SB_.CCST, BuffObj)
    External (_SB_.DPPN, IntObj)
    External (_SB_.GIO0, DeviceObj)
    External (_SB_.GIO0.GABL, IntObj)
    External (_SB_.HSFL, BuffObj)
    External (_SB_.I2C8, DeviceObj)
    External (_SB_.MUXC, BuffObj)
    ...
    Scope (\_SB)
    {
        Device (HWWD)
        {
            ...
            Method (OWDT, 0, NotSerialized)
            {
                ...
                {
                    WDB0 [Zero] = Zero
                    \_SB.I2C8.WRSP (0xD7, WDB0, One)
                }

                OESW = \_SB.I2C8.RESP (0x35, One)
                OESW |= 0x09
                WDB0 [Zero] = OESW /* \_SB_.HWWD.OESW */
                \_SB.I2C8.WRSP (0x35, WDB0, One)
                Return (0xFF01)
            }

            Method (EFLG, 0, NotSerialized)
            {
                If ((SMBF == One))
                {
                    If ((ECFG < 0x0F))
            ...
            Method (CWDT, 0, NotSerialized)
            {
                OESW = \_SB.I2C8.RESP (0x35, One)
                OESW &= 0xFE
                WDBF [Zero] = OESW /* \_SB_.HWWD.OESW */
                \_SB.I2C8.WRSP (0x35, WDBF, One)
                Return (0xFF02)
            }
            ...
            Method (SSXS, 1, Serialized)
            {
                Sleep (0x0A)
                WDBF [Zero] = Arg0
                \_SB.I2C8.NWEP (0x00083000, WDBF, One)
                Return (0xFF06)
            }
            ...
            {
                Local0 = Zero
                WDBF = \_SB.I2C8.NREP (0x00083000, One)
                Local0 = DerefOf (WDBF [Zero])
                Return (Local0)
            }
        }
    }
