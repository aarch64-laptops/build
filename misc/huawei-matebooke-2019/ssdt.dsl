 ...
 *
 * Disassembly of ssdt.dat, Thu Aug 27 00:11:44 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000653 (1619)
 *     Revision         0x02
 *     Checksum         0x82
 *     OEM ID           "HUAWEI"
 *     OEM Table ID     "UsbTCTbl"
 *     OEM Revision     0x00000001 (1)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20140214 (538182164)
 */
DefinitionBlock ("", "SSDT", 2, "HUAWEI", "UsbTCTbl", 0x00000001)
{
    External (_SB_.ECOK, UnknownObj)
    External (_SB_.GIO0, UnknownObj)
    External (_SB_.I2C8, UnknownObj)
    External (_SB_.I2C8.CMA0, UnknownObj)
    External (_SB_.I2C8.RBA0, IntObj)
    External (_SB_.I2C8.RBA1, UnknownObj)
                    ...
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (One)
                        {
                            ...
                            If ((\_SB.ECOK == One))
                            {
                                ...
                                \_SB.I2C8.RBA1 = BUFU /* \_SB_.UBTC.BUFU */
                                Release (\_SB.MUT0)
                            }
                        ...
                        Case (0x02)
                        {
                            ...
                            If ((\_SB.ECOK == One))
                            {
                                ...
                                BULN = One
                                BUD1 = Zero
                                \_SB.I2C8.CMA0 = BUFT /* \_SB_.UBTC.BUFT */
                                BUFU = \_SB.I2C8.RBA0 /* External reference */
                                If ((DerefOf (BUFU [Zero]) == Zero))
                                {
                                    ...
                                    VER1 = DerefOf (BUFU [0x02])
                                    VER2 = DerefOf (BUFU [0x03])
                                }
