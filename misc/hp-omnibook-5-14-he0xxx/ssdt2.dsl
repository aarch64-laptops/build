 ...
 */
DefinitionBlock ("", "SSDT", 1, "HPQOEM", "8E33    ", 0x00001000)
{
    External (_SB_.I2C6, DeviceObj)
    External (FNHB, UnknownObj)
    ...
    Scope (\_SB.I2C6)
    {
        ...
        Name (AVBL, Zero)
        Name (MIDV, Buffer (0x02)
        {
             0x00, 0x00                                       // ..
        })
        CreateField (MIDV, Zero, 0x08, MID0)
        CreateField (MIDV, 0x08, 0x08, MID1)
        ...
        Method (ICRC, 1, Serialized)
        {
            ...
            If ((Arg0 == 0xE1))
            {
                TPBF = ICE1 /* \_SB_.I2C6.ICE1 */
            }

            If ((Arg0 == 0xE4))
            {
                TPBF = ICE4 /* \_SB_.I2C6.ICE4 */
            }

            If ((Arg0 == 0xEE))
            {
                TPBF = ICEE /* \_SB_.I2C6.ICEE */
            }

            If ((Arg0 == 0xEF))
            {
                TPBF = ICEF /* \_SB_.I2C6.ICEF */
            }

            Return (TPBF) /* \_SB_.I2C6.ICRC.TPBF */
        }
        ...
        Method (ICWC, 2, Serialized)
        {
            ...
            If ((Arg0 == 0xE0))
            {
                ICE0 = TPBF /* \_SB_.I2C6.ICWC.TPBF */
            }

            If ((Arg0 == 0xE2))
            {
                ICE2 = TPBF /* \_SB_.I2C6.ICWC.TPBF */
            }

            If ((Arg0 == 0xE3))
            {
                ICE3 = TPBF /* \_SB_.I2C6.ICWC.TPBF */
            }

            If ((Arg0 == 0xED))
            {
                ICED = TPBF /* \_SB_.I2C6.ICWC.TPBF */
            }

            If ((Arg0 == 0xEE))
            {
                ICEE = TPBF /* \_SB_.I2C6.ICWC.TPBF */
            }

            Return (TPBF) /* \_SB_.I2C6.ICWC.TPBF */
        }

        Method (WC01, 2, NotSerialized)
        {
            Name (WTBF, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            })
            CreateField (WTBF, 0x10, 0x08, WTB0)
            CreateField (WTBF, 0x18, 0x08, WTB1)
            Debug = "WC01 is invoked"
            WTB0 = Arg0
            WTB1 = Arg1
            Acquire (\_SB.ECMX, 0xFFFF)
            \_SB.I2C6.CM01 = WTBF /* \_SB_.I2C6.WC01.WTBF */
            Sleep (0x05)
            Release (\_SB.ECMX)
        }

        Method (RD01, 0, NotSerialized)
        {
            Name (RDBF, Buffer (0x04)
            {
                 0xFF                                             // .
            })
            CreateField (RDBF, 0x10, 0x08, RDT0)
            CreateField (RDBF, 0x18, 0x08, RDT1)
            Name (RTBF, Buffer (0x02)
            {
                 0x00, 0x00                                       // ..
            })
            CreateField (RTBF, Zero, 0x08, DAT0)
            CreateField (RTBF, 0x08, 0x08, DAT1)
            Acquire (\_SB.ECMX, 0xFFFF)
            RDBF = \_SB.I2C6.CM01
            Sleep (0x05)
            Release (\_SB.ECMX)
            DAT0 = RDT0 /* \_SB_.I2C6.RD01.RDT0 */
            DAT1 = RDT1 /* \_SB_.I2C6.RD01.RDT1 */
            Return (RTBF) /* \_SB_.I2C6.RD01.RTBF */
        }

        Method (RW01, 1, NotSerialized)
        {
            MIDV = \_SB.I2C6.RD01 ()
            Name (TEM0, Zero)
            TEM0 = MID0 /* \_SB_.I2C6.MID0 */
            If ((Arg0 == Zero))
            {
                TEM0 &= 0xFD
            }
            ...
            MID0 = TEM0 /* \_SB_.I2C6.RW01.TEM0 */
            \_SB.I2C6.WC01 (MID0, MID1)
        }

        Method (RW02, 1, NotSerialized)
        {
            MIDV = \_SB.I2C6.RD01 ()
            Name (TEM0, Zero)
            TEM0 = MID0 /* \_SB_.I2C6.MID0 */
            ...
            MID0 = TEM0 /* \_SB_.I2C6.RW02.TEM0 */
            \_SB.I2C6.WC01 (MID0, MID1)
        }

        Method (RW03, 1, NotSerialized)
        {
            MIDV = \_SB.I2C6.RD01 ()
            Name (TEM0, Zero)
            TEM0 = MID0 /* \_SB_.I2C6.MID0 */
            ...
            MID0 = TEM0 /* \_SB_.I2C6.RW03.TEM0 */
            \_SB.I2C6.WC01 (MID0, MID1)
        }

        Method (CSTS, 0, NotSerialized)
        {
            Name (HSTS, Buffer (0x22){})
            CreateByteField (HSTS, 0x02, HSTA)
            HSTS = ICRC (0xEF)
            Return (HSTA) /* \_SB_.I2C6.CSTS.HSTA */
        }

        Method (SYKT, 0, NotSerialized)
        {
            Debug = "SYKT ENTER"
            Debug = \_SB.I2C6.AVBL
            Name (IC6F, Zero)
            If ((\_SB.I2C6.AVBL == Zero))
            {
                IC6F = One
                \_SB.I2C6.AVBL = One
                Debug = "Temporary enable I2C6 communication"
            }

            Name (BFKB, Buffer (0x22)
            {
                 0x00                                             // .
            })
            CreateByteField (BFKB, 0x02, KBTM)
            Local0 = Buffer (0x0400){}
            CreateByteField (Local0, Zero, BVAL)
            BFKB = \_SB.HQEX (0x05, 0xFE, One, Zero)
            Debug = "Read keyboard backlight timeout ram data done"
            If ((KBTM == 0x02))
            {
                BVAL = Zero
            }
            ...
            Local1 = \_SB.WMID.GECI ("Keyboard Backlight Timeout")
            \_SB.ECWC (Local1, One, Local0)
            Debug = "Write keyboard backlight timeout data to ROM done"
            If ((IC6F == One))
            {
                IC6F = Zero
                \_SB.I2C6.AVBL = Zero
                Debug = "End temporary enable I2C6 communication"
            }
        }

        Method (SKTR, 1, NotSerialized)
        {
            Local0 = Arg0
            \_SB.HQEX (0x05, Local0, Zero, Zero)
        }
    }

    Scope (\_SB)
    {
        Method (HQEX, 4, Serialized)
        {
            Name (OPTN, Zero)
            Name (EXDA, Buffer (0x22){})
            CreateByteField (EXDA, Zero, EXST)
            CreateByteField (EXDA, One, EXLE)
            CreateField (EXDA, 0x10, 0x0100, EXBF)
            Name (HEMD, Buffer (0x22){})
            CreateByteField (HEMD, Zero, CSTA)
            CreateByteField (HEMD, One, CLEN)
            CreateByteField (HEMD, 0x02, MCMD)
            CreateByteField (HEMD, 0x03, SCMD)
            CSTA = Zero
            CLEN = 0x02
            MCMD = Arg0
            SCMD = Arg1
            OPTN = Arg2
            Name (RTBF, Buffer (0x22){})
            CreateByteField (RTBF, Zero, RSTA)
            Acquire (\_SB.ECMX, 0xFFFF)
            Local0 = Zero
            While ((Local0 < 0x14))
            {
                Local1 = \_SB.I2C6.CSTS ()
                If ((Local1 == Zero))
                {
                    Break
                }
            ...
            If ((Local0 == 0x14))
            {
                RSTA = 0xFF
                Release (\_SB.ECMX)
                Return (RTBF) /* \_SB_.HQEX.RTBF */
            }

            If ((OPTN == 0x02))
            {
                EXDA = Arg3
                EXDA = \_SB.I2C6.ICWC (0xEE, EXDA)
                If ((EXST != Zero))
                {
                    RSTA = 0xFF
                    Release (\_SB.ECMX)
    ...
    Scope (\_SB)
    {
        Method (APET, 1, Serialized)
        {
            If ((Arg0 == One))
            {
                \_SB.HQEX (One, 0x80, Zero, Zero)
            }

            If ((Arg0 == Zero))
            {
                \_SB.HQEX (One, Zero, Zero, Zero)
            }
        }

        Method (MSET, 1, Serialized)
        {
            If ((Arg0 == One))
            {
                \_SB.HQEX (One, 0x82, Zero, Zero)
            }

            If ((Arg0 == Zero))
            {
                \_SB.HQEX (One, 0x02, Zero, Zero)
            }
        }

        Method (SCET, 1, Serialized)
        {
            If ((Arg0 == One))
            {
                \_SB.HQEX (One, 0x81, Zero, Zero)
            }

            If ((Arg0 == Zero))
            {
                \_SB.HQEX (One, One, Zero, Zero)
            }
        }

        Method (TWTE, 2, Serialized)
        {
            Name (BUF0, Buffer (0x22){})
            Switch (Arg0)
            {
                Case (One)
                {
                    BUF0 = Arg1
                    BUF0 = \_SB.HQEX (0x27, 0xFF, 0x02, BUF0)
                }
                Case (0x02)
                {
                    BUF0 = Arg1
                    BUF0 = \_SB.HQEX (0x27, Zero, 0x02, BUF0)
                }
                Case (0x03)
                {
                    BUF0 = Arg1
                    BUF0 = \_SB.HQEX (0x27, One, 0x02, BUF0)
                }
                Case (0x04)
                {
                    BUF0 = Arg1
                    BUF0 = \_SB.HQEX (0x27, 0x02, 0x02, BUF0)
                }
                Case (0x05)
                {
                    BUF0 = Arg1
                    BUF0 = \_SB.HQEX (0x27, 0x03, 0x02, BUF0)
                }
                Case (0x06)
                {
                    BUF0 = Arg1
                    BUF0 = \_SB.HQEX (0x27, 0x04, 0x02, BUF0)
                }
                Case (0x07)
                {
                    BUF0 = Arg1
                    BUF0 = \_SB.HQEX (0x27, 0x05, 0x02, BUF0)
                }
                Case (0x08)
                {
                    BUF0 = Arg1
                    BUF0 = \_SB.HQEX (0x27, 0x06, 0x02, BUF0)
                }

            }

            Return (BUF0) /* \_SB_.TWTE.BUF0 */
        }

        Method (TRFE, 1, Serialized)
        {
            Name (BUF0, Buffer (0x22){})
            CreateByteField (BUF0, Zero, STA0)
            CreateByteField (BUF0, One, LEN0)
            CreateField (BUF0, 0x10, 0x08, DAT0)
            Switch (Arg0)
            {
                Case (One)
                {
                    BUF0 = \_SB.HQEX (0x26, Zero, One, Zero)
                }
                Case (0x02)
                {
                    BUF0 = \_SB.HQEX (0x26, One, One, Zero)
                }
                Case (0x06)
                {
                    BUF0 = \_SB.HQEX (0x26, 0x05, One, Zero)
                }
                Case (0x07)
                {
                    BUF0 = \_SB.HQEX (0x26, 0x06, One, Zero)
                }

            }

            Return (BUF0) /* \_SB_.TRFE.BUF0 */
        }

        Method (SETT, 2, Serialized)
        {
            Name (BUF0, Buffer (0x22){})
            BUF0 = Arg1
            Switch (Arg0)
            {
                Case (One)
                {
                    BUF0 = \_SB.HQEX (0x28, Zero, 0x02, BUF0)
                }
                Case (0x02)
                {
                    BUF0 = \_SB.HQEX (0x28, One, 0x02, BUF0)
                }
                Case (0x06)
                {
                    BUF0 = \_SB.HQEX (0x28, 0x05, 0x02, BUF0)
                }
                Case (0x07)
                {
                    BUF0 = \_SB.HQEX (0x28, 0x06, 0x02, BUF0)
                }

            }

            Return (BUF0) /* \_SB_.SETT.BUF0 */
        }
        ...
        Method (GETT, 1, Serialized)
        {
            ...
            Switch (Arg0)
            {
                Case (One)
                {
                    BUF0 = \_SB.HQEX (0x28, 0x80, One, Zero)
                }
                Case (0x02)
                {
                    BUF0 = \_SB.HQEX (0x28, 0x81, One, Zero)
                }
                Case (0x06)
                {
                    BUF0 = \_SB.HQEX (0x28, 0x85, One, Zero)
                }
                Case (0x07)
                {
                    BUF0 = \_SB.HQEX (0x28, 0x86, One, Zero)
                }

            }

            Return (BUF0) /* \_SB_.GETT.BUF0 */
        }
    }
    ...
    {
        Name (STS1, Zero)
        Method (ICST, 0, NotSerialized)
        {
            Return (STS1) /* \_SB_.I2C6.STS1 */
        }

        Method (RCB0, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x06)
            {
                 0xFF                                             // .
            })
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x20, DBUF)
            Debug = "RCB0 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMB0
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCB0.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCB0.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCB0.STAT */
            Return (Local0)
        }

        Method (RCB1, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x06)
            {
                 0xFF                                             // .
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x20, DBUF)
            Debug = "RCB1 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMB1
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCB1.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCB1.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCB1.STAT */
            Return (Local0)
        }

        Method (RCB2, 0, NotSerialized)
        {
            ...
            Debug = "RCB2 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMB2
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCB2.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCB2.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCB2.STAT */
            Return (Local0)
        }

        Method (WCB2, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "WCB2 is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CMB2 = EEDP /* \_SB_.I2C6.WCB2.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCB2.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCB2.STAT */
            Return (Local0)
        }

        Method (RCB3, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCB3 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMB3
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCB3.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCB3.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCB3.STAT */
            Return (Local0)
        }

        Method (WCB3, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "WCB3 is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CMB3 = EEDP /* \_SB_.I2C6.WCB3.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCB3.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCB3.STAT */
            Return (Local0)
        }

        Method (RCB4, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCB4 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMB4
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCB4.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCB4.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCB4.STAT */
            Return (Local0)
        }

        Method (WCB4, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "WCB4 is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CMB4 = EEDP /* \_SB_.I2C6.WCB4.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCB4.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCB4.STAT */
            Return (Local0)
        }

        Method (RCB5, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCB5 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMB5
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCB5.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCB5.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCB5.STAT */
            Return (Local0)
        }

        Method (WCB5, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "WCB5 is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CMB5 = EEDP /* \_SB_.I2C6.WCB5.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCB5.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCB5.STAT */
            Return (Local0)
        }

        Method (RCB6, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCB6 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMB6
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCB6.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCB6.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCB6.STAT */
            Return (Local0)
        }

        Method (RCB7, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCB7 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMB7
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCB7.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCB7.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCB7.STAT */
            Return (Local0)
        }

        Method (RCB8, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCB8 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMB8
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCB8.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCB8.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCB8.STAT */
            Return (Local0)
        }

        Method (WCB8, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "WCB8 is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CMB8 = EEDP /* \_SB_.I2C6.WCB8.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCB8.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCB8.STAT */
            Return (Local0)
        }

        Method (RCB9, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            })
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCB9 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMB9
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCB9.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCB9.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCB9.STAT */
            Return (Local0)
        }

        Method (RCBA, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCBA is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMBA
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCBA.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCBA.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCBA.STAT */
            Local0 = STAT /* \_SB_.I2C6.RCBA.STAT */
            Return (Local0)
        }

        Method (WCBB, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "WCC0 is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CMBB = EEDP /* \_SB_.I2C6.WCBB.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCBB.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCBB.STAT */
            Return (Local0)
        }

        Method (WCBC, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "WCBC is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CMBC = EEDP /* \_SB_.I2C6.WCBC.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCBC.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCBC.STAT */
            Return (Local0)
        }

        Method (RCBD, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCBD is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMBD
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCBD.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCBD.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCBD.STAT */
            Return (Local0)
        }

        Method (WCBD, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "WCBD is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CMBD = EEDP /* \_SB_.I2C6.WCBD.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCBD.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCBD.STAT */
            Return (Local0)
        }

        Method (RCBE, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCBE is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMBE
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCBE.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCBE.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCBE.STAT */
            Return (Local0)
        }

        Method (WCBE, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "WCBE is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CMBE = EEDP /* \_SB_.I2C6.WCBE.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCBE.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCBE.STAT */
            Return (Local0)
        }

        Method (RCC0, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCC0 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMC0
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCC0.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCC0.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCC0.STAT */
            Return (Local0)
        }

        Method (WCC0, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CMC0 = EEDP /* \_SB_.I2C6.WCC0.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCC0.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCC0.STAT */
            Return (Local0)
        }

        Method (RCC1, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x12)
            {
                 0xFF                                             // .
            })
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x80, DBUF)
            Debug = "RCC1 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMC1
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCC1.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCC1.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCC1.STAT */
            Return (Local0)
        }

        Method (RCC2, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCC2 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMC2
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCC2.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCC2.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCC2.STAT */
            Return (Local0)
        }

        Method (RCC3, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCC3 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMC3
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCC3.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCC3.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCC3.STAT */
            Return (Local0)
        }

        Method (RCC4, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCC4 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMC4
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCC4.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCC4.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCC4.STAT */
            Return (Local0)
        }

        Method (RCC5, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCC5 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMC5
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCC5.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCC5.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCC5.STAT */
            Return (Local0)
        }

        Method (RCC6, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCC6 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMC6
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCC6.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCC6.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCC6.STAT */
            Return (Local0)
        }

        Method (RCC7, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCC7 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMC7
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCC7.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCC7.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCC7.STAT */
            Return (Local0)
        }

        Method (RCC8, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCC8 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMC8
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCC8.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCC8.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCC8.STAT */
            Return (Local0)
        }

        Method (RCC9, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCC9 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMC9
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCC9.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCC9.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCC9.STAT */
            Return (Local0)
        }

        Method (RCCA, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCCA is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMCA
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCCA.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCCA.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCCA.STAT */
            Return (Local0)
        }

        Method (RCCB, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCCB is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMCB
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCCB.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCCB.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCCB.STAT */
            Return (Local0)
        }

        Method (RCCC, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCCC is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMCC
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCCC.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCCC.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCCC.STAT */
            Return (Local0)
        }

        Method (WCCC, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "WCCC is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CMCC = EEDP /* \_SB_.I2C6.WCCC.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCCC.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCCC.STAT */
            Return (Local0)
        }

        Method (RCCD, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCCD is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMCD
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCCD.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCCD.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCCD.STAT */
            Return (Local0)
        }

        Method (WCCD, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "WCCD is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CMCD = EEDP /* \_SB_.I2C6.WCCD.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCCD.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCCD.STAT */
            Return (Local0)
        }

        Method (RCCE, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCCE is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMCE
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCCE.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCCE.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCCE.STAT */
            Return (Local0)
        }

        Method (RCCF, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x04)
            {
                 0x00, 0x01, 0x00, 0x00                           // ....
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x10, DBUF)
            Debug = "RCCF is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMCF
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCCF.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCCF.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCCF.STAT */
            Return (Local0)
        }

        Method (RCD0, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x12)
            {
                 0xFF                                             // .
            ...
            EEDP = \_SB.I2C6.CMD0
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCD0.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCD0.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCD0.STAT */
            Return (Local0)
        }

        Method (RCD1, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x12)
            {
                 0xFF                                             // .
            ...
            EEDP = \_SB.I2C6.CMD1
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCD1.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCD1.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCD1.STAT */
            Return (Local0)
        }

        Method (RCD2, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x1A)
            {
                 0xFF                                             // .
            })
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0xC0, DBUF)
            Debug = "RCC1 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMD2
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCD2.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCD2.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCD2.STAT */
            Return (Local0)
        }

        Method (RCD6, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCD6 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMD6
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCD6.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCD6.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCD6.STAT */
            Return (Local0)
        }

        Method (RCE5, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCE5 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CME5
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCE5.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCE5.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCE5.STAT */
            Return (Local0)
        }

        Method (WCE5, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "WCE5 is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CME5 = EEDP /* \_SB_.I2C6.WCE5.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCE5.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCE5.STAT */
            Return (Local0)
        }

        Method (RCE6, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCE6 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CME6
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCE6.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCE6.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCE6.STAT */
            Return (Local0)
        }

        Method (RCE7, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "RCE7 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CME7
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCE7.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCE7.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCE7.STAT */
            Return (Local0)
        }

        Method (WCE7, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 // ...
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x08, DBUF)
            Debug = "WCE7 is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CME7 = EEDP /* \_SB_.I2C6.WCE7.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCE7.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCE7.STAT */
            Return (Local0)
        }

        Method (RCE8, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x07)
            {
                 0xFF                                             // .
            })
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x28, DBUF)
            Debug = "RCE8 is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CME8
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCE8.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCE8.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCE8.STAT */
            Return (Local0)
        }

        Method (RCFD, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x42)
            {
                 0xFF                                             // .
            })
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x0200, DBUF)
            Debug = "RCFF is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMFD
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCFD.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCFD.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCFD.STAT */
            Return (Local0)
        }

        Method (WCFD, 1, NotSerialized)
        {
            Name (EEDP, Buffer (0x42)
            {
                 0xFF                                             // .
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x0200, DBUF)
            Debug = "WCFF is invoked"
            DBUF = Arg0
            Acquire (\_SB.MUT0, 0xFFFF)
            \_SB.I2C6.CMFD = EEDP /* \_SB_.I2C6.WCFD.EEDP */
            Release (\_SB.MUT0)
            STS1 = STAT /* \_SB_.I2C6.WCFD.STAT */
            Local0 = STAT /* \_SB_.I2C6.WCFD.STAT */
            Return (Local0)
        }

        Method (RCFE, 0, NotSerialized)
        {
            Name (EEDP, Buffer (0x42)
            {
                 0xFF                                             // .
            ...
            CreateByteField (EEDP, Zero, STAT)
            CreateField (EEDP, 0x10, 0x0200, DBUF)
            Debug = "RCFE is invoked"
            Acquire (\_SB.MUT0, 0xFFFF)
            EEDP = \_SB.I2C6.CMFE
            Release (\_SB.MUT0)
            Debug = EEDP /* \_SB_.I2C6.RCFE.EEDP */
            Local0 = DBUF /* \_SB_.I2C6.RCFE.DBUF */
            STS1 = STAT /* \_SB_.I2C6.RCFE.STAT */
            Return (Local0)
        }
    }
    ...
    Scope (\_SB)
    {
        ...
        Device (\_SB.WMID)
        {
            ...
            Name (_WDG, Buffer (0x0104)
            {
                ...
                /* 0088 */  0x42, 0x44, 0x14, 0x00, 0x46, 0x97, 0xEA, 0x14,  // BD..F...
            ...
            Name (FSB5, Zero)
            Name (FSB6, Zero)
            OperationRegion (OHFL, SystemMemory, 0xD46D8018, 0x0000002B)
            ...
            Method (GBTI, 1, NotSerialized)
            {
                ...
                Local0 = \_SB.HQEX (0x0A, Zero, One, Zero)
                Local1 = (DerefOf (Local0 [0x02]) & 0x04)
                If ((Local1 != 0x04))
                {
                    RTCC = 0x34
                    Local0 = Package (0x03)
                ...
                Name (WM7A, Buffer (0x22){})
                WM7A = \_SB.HQEX (0xBA, 0x19, One, Zero)
                DerefOf (Local0 [0x02]) [0x10] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x11] = DerefOf (WM7A [
                    0x03])
                Local2 = (DerefOf (WM7A [0x03]) << 0x08)
                Local2 += DerefOf (WM7A [0x02])
                WM7A = \_SB.HQEX (0xBA, 0x18, One, Zero)
                Local3 = (DerefOf (WM7A [0x03]) << 0x08)
                Local3 += DerefOf (WM7A [0x02])
                Local3 *= 0x2710
                Local3 /= Local2
                Local4 = (Local3 & 0xFF)
                Local5 = (Local3 >> 0x08)
                DerefOf (Local0 [0x02]) [Zero] = Local4
                DerefOf (Local0 [0x02]) [One] = Local5
                WM7A = \_SB.HQEX (0xBA, 0x10, One, Zero)
                Local3 = (DerefOf (WM7A [0x03]) << 0x08)
                Local3 += DerefOf (WM7A [0x02])
                Local3 *= 0x2710
                Local3 /= Local2
                Local4 = (Local3 & 0xFF)
                Local5 = (Local3 >> 0x08)
                DerefOf (Local0 [0x02]) [0x02] = Local4
                DerefOf (Local0 [0x02]) [0x03] = Local5
                WM7A = \_SB.HQEX (0xBA, 0x0F, One, Zero)
                Local3 = (DerefOf (WM7A [0x03]) << 0x08)
                Local3 += DerefOf (WM7A [0x02])
                Local3 *= 0x2710
                Local3 /= Local2
                Local4 = (Local3 & 0xFF)
                Local5 = (Local3 >> 0x08)
                DerefOf (Local0 [0x02]) [0x04] = Local4
                DerefOf (Local0 [0x02]) [0x05] = Local5
                WM7A = \_SB.HQEX (0xBA, 0x0C, One, Zero)
                DerefOf (Local0 [0x02]) [0x06] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x07] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x17, One, Zero)
                DerefOf (Local0 [0x02]) [0x08] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x09] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x08, One, Zero)
                Local1 = (DerefOf (WM7A [0x03]) << 0x08)
                Local2 = (DerefOf (WM7A [0x02]) | Local1)
                Local3 = (Local2 - 0x0AAA)
                Divide (Local3, 0x0A, Local4, Local5)
                DerefOf (Local0 [0x02]) [0x0A] = Local5
                DerefOf (Local0 [0x02]) [0x0B] = Zero
                WM7A = \_SB.HQEX (0xBA, 0x09, One, Zero)
                DerefOf (Local0 [0x02]) [0x0C] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x0D] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x0A, One, Zero)
                DerefOf (Local0 [0x02]) [0x0E] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x0F] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x16, One, Zero)
                DerefOf (Local0 [0x02]) [0x12] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x13] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x3F, One, Zero)
                DerefOf (Local0 [0x02]) [0x14] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x15] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x3E, One, Zero)
                DerefOf (Local0 [0x02]) [0x16] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x17] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x3D, One, Zero)
                DerefOf (Local0 [0x02]) [0x18] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x19] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x3C, One, Zero)
                DerefOf (Local0 [0x02]) [0x1A] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x1B] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x1C, One, Zero)
                Local2 = (DerefOf (WM7A [0x03]) << 0x08)
                Local2 += DerefOf (WM7A [0x02])
                ...
                WM7A = \_SB.HQEX (0xBA, 0x20, One, Zero)
                DerefOf (Local0 [0x02]) [0x2C] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x2D] = DerefOf (WM7A [
                    0x03])
                DerefOf (Local0 [0x02]) [0x2E] = DerefOf (WM7A [
                    0x04])
                DerefOf (Local0 [0x02]) [0x2F] = DerefOf (WM7A [
                    0x05])
                DerefOf (Local0 [0x02]) [0x30] = DerefOf (WM7A [
                    0x06])
                DerefOf (Local0 [0x02]) [0x31] = DerefOf (WM7A [
                    0x07])
                DerefOf (Local0 [0x02]) [0x32] = DerefOf (WM7A [
                    0x08])
                DerefOf (Local0 [0x02]) [0x33] = DerefOf (WM7A [
                    0x09])
                DerefOf (Local0 [0x02]) [0x34] = DerefOf (WM7A [
                    0x0A])
                DerefOf (Local0 [0x02]) [0x35] = DerefOf (WM7A [
                    0x0B])
                DerefOf (Local0 [0x02]) [0x36] = DerefOf (WM7A [
                    0x0C])
                DerefOf (Local0 [0x02]) [0x37] = DerefOf (WM7A [
                    0x0D])
                DerefOf (Local0 [0x02]) [0x38] = DerefOf (WM7A [
                    0x0E])
                DerefOf (Local0 [0x02]) [0x39] = DerefOf (WM7A [
                    0x0F])
                DerefOf (Local0 [0x02]) [0x3A] = DerefOf (WM7A [
                    0x10])
                DerefOf (Local0 [0x02]) [0x3B] = DerefOf (WM7A [
                    0x11])
                DerefOf (Local0 [0x02]) [0x3C] = DerefOf (WM7A [
                    0x12])
                DerefOf (Local0 [0x02]) [0x3D] = DerefOf (WM7A [
                    0x13])
                WM7A = \_SB.HQEX (0xBA, 0x70, One, Zero)
                DerefOf (Local0 [0x02]) [0x3E] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x3F] = DerefOf (WM7A [
                    0x03])
                DerefOf (Local0 [0x02]) [0x40] = DerefOf (WM7A [
                    0x04])
                DerefOf (Local0 [0x02]) [0x41] = DerefOf (WM7A [
                    0x05])
                DerefOf (Local0 [0x02]) [0x42] = DerefOf (WM7A [
                    0x06])
                DerefOf (Local0 [0x02]) [0x43] = DerefOf (WM7A [
                    0x07])
                DerefOf (Local0 [0x02]) [0x44] = DerefOf (WM7A [
                    0x08])
                DerefOf (Local0 [0x02]) [0x45] = DerefOf (WM7A [
                    0x09])
                DerefOf (Local0 [0x02]) [0x46] = DerefOf (WM7A [
                    0x0A])
                DerefOf (Local0 [0x02]) [0x47] = DerefOf (WM7A [
                    0x0B])
                DerefOf (Local0 [0x02]) [0x48] = DerefOf (WM7A [
                    0x0C])
                DerefOf (Local0 [0x02]) [0x49] = DerefOf (WM7A [
                    0x0D])
                DerefOf (Local0 [0x02]) [0x4A] = DerefOf (WM7A [
                    0x0E])
                DerefOf (Local0 [0x02]) [0x4B] = DerefOf (WM7A [
                    0x0F])
                DerefOf (Local0 [0x02]) [0x4C] = DerefOf (WM7A [
                    0x10])
                DerefOf (Local0 [0x02]) [0x4D] = DerefOf (WM7A [
                    0x11])
                WM7A = \_SB.HQEX (0xBA, 0x21, One, Zero)
                DerefOf (Local0 [0x02]) [0x4F] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x50] = DerefOf (WM7A [
                    0x03])
                DerefOf (Local0 [0x02]) [0x51] = DerefOf (WM7A [
                    0x04])
                DerefOf (Local0 [0x02]) [0x52] = DerefOf (WM7A [
                    0x05])
                DerefOf (Local0 [0x02]) [0x53] = DerefOf (WM7A [
                    0x06])
                DerefOf (Local0 [0x02]) [0x54] = DerefOf (WM7A [
                    0x07])
                DerefOf (Local0 [0x02]) [0x55] = DerefOf (WM7A [
                    0x08])
                WM7A = \_SB.HQEX (0xBA, 0x22, One, Zero)
                DerefOf (Local0 [0x02]) [0x56] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x57] = DerefOf (WM7A [
                    0x03])
                DerefOf (Local0 [0x02]) [0x58] = DerefOf (WM7A [
                    0x04])
                DerefOf (Local0 [0x02]) [0x59] = DerefOf (WM7A [
                    0x05])
                WM7A = \_SB.HQEX (0xBA, Zero, One, Zero)
                DerefOf (Local0 [0x02]) [0x5A] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x5B] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x1B, One, Zero)
                Local2 = (DerefOf (WM7A [0x03]) << 0x08)
                Local2 += DerefOf (WM7A [0x02])
                ...
                DerefOf (Local0 [0x02]) [0x5C] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x5D] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x14, One, Zero)
                DerefOf (Local0 [0x02]) [0x5E] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x5F] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x15, One, Zero)
                DerefOf (Local0 [0x02]) [0x60] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x61] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x0B, One, Zero)
                DerefOf (Local0 [0x02]) [0x62] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x63] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x11, One, Zero)
                DerefOf (Local0 [0x02]) [0x64] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x65] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x12, One, Zero)
                DerefOf (Local0 [0x02]) [0x66] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x67] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0x13, One, Zero)
                DerefOf (Local0 [0x02]) [0x66] = DerefOf (WM7A [
                    0x02])
                DerefOf (Local0 [0x02]) [0x67] = DerefOf (WM7A [
                    0x03])
                WM7A = \_SB.HQEX (0xBA, 0xFE, One, Zero)
                DerefOf (Local0 [0x02]) [0x6A] = DerefOf (WM7A [
                    0x02])
                Return (Local0)
            }
            ...
            Method (GAST, 0, NotSerialized)
            {
                ...
                Local1 = \_SB.HQEX (0x0A, Zero, One, Zero)
                Local2 = (DerefOf (Local1 [0x02]) & 0x02)
                If ((Local2 == 0x02))
                {
                    If ((DerefOf (Local1 [0x03]) == Zero))
                    {
            ...
            {
                CreateField (Arg0, 0x80, 0x08, CMD0)
                Name (BUF2, Buffer (0x22){})
                Local1 = Package (0x03)
                    {
                        Zero, 
                ...
                Switch (CMD0)
                {
                    Case (Zero)
                    {
                        BUF2 = \_SB.HQEX (0x26, Zero, One, Zero)
                        DerefOf (Local1 [0x02]) [Zero] = One
                        DerefOf (Local1 [0x02]) [One] = DerefOf (BUF2 [
                            0x02])
                    }
                    Case (One)
                    {
                        DerefOf (Local1 [0x02]) [Zero] = Zero
                    }
                    Case (0x02)
                    {
                        BUF2 = \_SB.HQEX (0x26, 0x06, One, Zero)
                        DerefOf (Local1 [0x02]) [Zero] = One
                        DerefOf (Local1 [0x02]) [One] = DerefOf (BUF2 [
                            0x02])
                    }
                    Case (0x03)
                    {
                        BUF2 = \_SB.HQEX (0xBC, 0x02, One, Zero)
                        DerefOf (Local1 [0x02]) [Zero] = One
                        DerefOf (Local1 [0x02]) [One] = DerefOf (BUF2 [
                            0x02])
                    }
                    Case (0x04)
                    {
                        BUF2 = \_SB.HQEX (0xBA, 0x08, One, Zero)
                        Local2 = (DerefOf (BUF2 [0x03]) << 0x10)
                        Local2 += DerefOf (BUF2 [0x02])
                        Local2 = ((Local2 - 0x0AAA) / 0x0A)
                        DerefOf (Local1 [0x02]) [Zero] = One
                        DerefOf (Local1 [0x02]) [One] = Local2
                    }
                    Case (0x06)
                    {
                        BUF2 = \_SB.HQEX (0xBC, One, One, Zero)
                        DerefOf (Local1 [0x02]) [Zero] = One
                        DerefOf (Local1 [0x02]) [One] = DerefOf (BUF2 [
                            0x02])
                    }
                    Case (0x07)
                    {
                        BUF2 = \_SB.HQEX (0xBC, 0x03, One, Zero)
                        DerefOf (Local1 [0x02]) [Zero] = One
                        DerefOf (Local1 [0x02]) [0x02] = DerefOf (BUF2 [
                            0x02])
                        DerefOf (Local1 [0x02]) [One] = DerefOf (BUF2 [
                            0x03])
                    }
                    Case (0x09)
                    {
                        BUF2 = \_SB.HQEX (0xBC, 0x05, One, Zero)
                        DerefOf (Local1 [0x02]) [Zero] = One
                        DerefOf (Local1 [0x02]) [0x02] = DerefOf (BUF2 [
                            0x02])
                        DerefOf (Local1 [0x02]) [One] = DerefOf (BUF2 [
                    ...
                    Case (0x0A)
                    {
                        BUF2 = \_SB.HQEX (0x26, One, One, Zero)
                        DerefOf (Local1 [0x02]) [Zero] = One
                        DerefOf (Local1 [0x02]) [One] = DerefOf (BUF2 [
                            0x02])
                    }
                    Case (0x20)
                    {
                        BUF2 = \_SB.HQEX (0xBC, 0xF0, One, Zero)
                        DerefOf (Local1 [0x02]) [Zero] = One
                        DerefOf (Local1 [0x02]) [One] = DerefOf (BUF2 [
                            0x03])
                    }
            ...
            Method (STDC, 1, Serialized)
            {
                ...
                CreateByteField (Arg0, 0x10, CMD0)
                CreateByteField (Arg0, 0x11, SENN)
                CreateByteField (Arg0, 0x12, DAT0)
                CreateByteField (Arg0, 0x13, DAT1)
                Name (BUF0, Buffer (0x22){})
                Switch (CMD0)
                {
                    Case (0x20)
                    {
                        ...
                        BUF0 [One] = One
                        BUF0 [0x02] = DAT0 /* \_SB_.WMID.STDC.DAT0 */
                        BUF0 = \_SB.HQEX (0xBC, 0x20, 0x02, BUF0)
                    }
                    Case (0x21)
                    {
                        If ((SENN != One))
                        ...
                        BUF0 [One] = One
                        BUF0 [0x02] = DAT0 /* \_SB_.WMID.STDC.DAT0 */
                        BUF0 = \_SB.HQEX (0xBC, 0x21, 0x02, BUF0)
                    }
                    Case (0x22)
                    {
                        If ((SENN != One))
                        ...
                        BUF0 [One] = One
                        BUF0 [0x02] = DAT0 /* \_SB_.WMID.STDC.DAT0 */
                        BUF0 = \_SB.HQEX (0xBC, 0x22, 0x02, BUF0)
                    }
                    Case (0x23)
                    {
                        If ((SENN != One))
                        ...
                        BUF0 [One] = 0x02
                        BUF0 [0x02] = DAT0 /* \_SB_.WMID.STDC.DAT0 */
                        BUF0 [0x03] = DAT1 /* \_SB_.WMID.STDC.DAT1 */
                        BUF0 = \_SB.HQEX (0xBC, 0x23, 0x02, BUF0)
                    }
                    Case (0x24)
                    {
                        If ((SENN != One))
                        ...
                        BUF0 [One] = One
                        BUF0 [0x02] = DAT0 /* \_SB_.WMID.STDC.DAT0 */
                        BUF0 = \_SB.HQEX (0xBC, 0x24, 0x02, BUF0)
                    }
                    Case (0xAA)
                    {
                        BUF0 = \_SB.HQEX (0xBC, 0xAA, Zero, BUF0)
                    }
                    Default
                    {
                        RTCC = 0x06
            ...
            Method (GBCC, 0, NotSerialized)
            {
                ...
                Name (WM2B, Buffer (0x22){})
                WM2B = \_SB.HQEX (0xBB, 0xFF, One, Zero)
                DerefOf (Local0 [0x02]) [Zero] = DerefOf (WM2B [
                    0x02])
            ...
            {
                Name (BBCT, Buffer (0x14){})
                BBCT = Arg0
                Local0 = DerefOf (BBCT [0x10])
                Local1 = DerefOf (BBCT [0x11])
                If ((Local1 == Zero))
                {
                    \_SB.HQEX (0xBB, Zero, Zero, Zero)
                }

                If ((Local1 == One))
                {
                    \_SB.HQEX (0xBB, One, Zero, Zero)
                }

                If ((Local1 == 0x02))
                {
                    \_SB.HQEX (0xBB, 0x02, Zero, Zero)
                }
                ...
                If ((Local1 == 0x04))
                {
                    \_SB.HQEX (0xBB, 0x04, Zero, Zero)
                }

                If ((Local1 == 0x05))
                {
                    \_SB.HQEX (0xBB, 0x05, Zero, Zero)
                }

                If ((Local1 == 0x06))
                {
                    \_SB.HQEX (0xBB, 0x06, Zero, Zero)
                }
            ...
            {
                Debug = "SBKT is running"
                Debug = Arg0
                CreateByteField (Arg0, 0x10, BKD0)
                Name (BKD1, Zero)
                If ((BKD0 == One))
                {
                    BKD1 = 0x02
            ...
            Method (GABO, 0, NotSerialized)
            {
                ...
                CreateField (DerefOf (Local0 [0x02]), Zero, 0x0400, BUFS)
                Name (OPDT, Buffer (0x80){})
                CreateField (OPDT, 0x10, 0xE0, VADT)
                OPDT = \_SB.HQEX (0xBA, 0xFA, One, Zero)
                BUFS = VADT /* \_SB_.WMID.GABO.VADT */
                Return (Local0)
            }
            ...
            Method (GMLS, 0, NotSerialized)
            {
                ...
                CreateField (DerefOf (Local0 [0x02]), Zero, 0x02, BUFS)
                Name (GLED, Buffer (0x22){})
                GLED = \_SB.HQEX (0x06, 0xFF, One, Zero)
                CreateBitField (GLED, 0x18, LED0)
                CreateBitField (GLED, 0x19, LED1)
                If (((LED0 == Zero) & (LED1 == Zero)))
                {
                    BUFS = Zero
                }

                If (((LED0 == One) & (LED1 == Zero)))
                {
                    BUFS = One
                }

                If (((LED0 == Zero) & (LED1 == One)))
                {
                    BUFS = 0x02
                }

                If (((LED0 == One) & (LED1 == One)))
                {
                    BUFS = 0x03
                }
            ...
            {
                Name (EEDP, Buffer (0x14){})
                EEDP = Arg0
                CreateBitField (EEDP, 0x80, LED2)
                CreateBitField (EEDP, 0x81, LED3)
                \_SB.HQEX (One, 0x84, Zero, Zero)
                If ((LED2 == Zero))
                {
                    \_SB.HQEX (0x06, 0x08, Zero, Zero)
                }

                If ((LED2 == One))
                {
                    \_SB.HQEX (0x06, 0x88, Zero, Zero)
                }

                If ((LED3 == Zero))
                {
                    \_SB.HQEX (0x06, 0x09, Zero, Zero)
                }

                If ((LED3 == One))
                {
                    \_SB.HQEX (0x06, 0x89, Zero, Zero)
                }
            ...
            Method (_WED, 1, NotSerialized)  // _Wxx: Wake Event, xx=0x00-0xFF
            {
                ...
                If ((Arg0 == 0x80))
                {
                    ...
                    ElseIf ((EVID == 0x0D))
                    {
                        Debug = "Backlight keyboard brightness event 0x0D running!"
                        CreateByteField (Local0, 0x04, BLLV)
                        Name (BFBL, Buffer (0x22)
                        {
                             0x00                                             // .
                        })
                        CreateByteField (BFBL, 0x02, BLTM)
                        BFBL = \_SB.HQEX (0x05, 0xFF, One, Zero)
                        BLLV = BLTM /* \_SB_.WMID._WED.BLTM */
                        Debug = Local0
                        Return (Local0)
                    }
                    ElseIf ((EVID == 0x1D))
                    {
                        Debug = "Hot key Event 0x1D running!"
                        Debug = EVDA /* \_SB_.WMID._WED.EVDA */
                        CreateWordField (Local0, 0x04, HTID)
                        HTID = EVDA /* \_SB_.WMID._WED.EVDA */
                        Local1 = HTID /* \_SB_.WMID._WED.HTID */
                        EVDA = Zero
                        HTID = Local1
                        If ((HTID == 0x21AA))
                        {
                            CreateByteField (Local0, 0x06, PWMV)
                            CreateByteField (Local0, 0x07, TMOD)
                            Name (BFKB, Buffer (0x22)
                            {
                                 0x00                                             // .
                            })
                            ...
                            BFKB = \_SB.HQEX (0x05, 0xFF, One, Zero)
                            PWMV = (KBTM * 0x32)
                        }
                ...
                Switch (ToInteger (Arg0))
                {
                    ...
                    Case (0x27)
                    {
                        Local0 = Package (0x18)
                            {
                                "Keyboard Type", 
                                "*Non-Japanese (Default US), Japanese Keyboard, New EMEA UK KB (US2), New BRZL KB (UK2), New BRZL KB (US3), US4 (LA KB), US5 (Europe KB), US6 (Korea KB), US7 (Brazil KB)", 
                                "System Configuration", 
                                Zero, 
                                One, 
                                Zero, 
            ...
            Method (SECV, 4, NotSerialized)
            {
                ...
                ElseIf ((NSTR == "Keyboard Type"))
                {
                    ...
                    {
                        Local6 = GECI (NSTR)
                        If ((VSTR == "Non-Japanese (Default US)"))
                        {
                            BVAL = Zero
                        }
                ...
                ElseIf ((NSTR == "Keyboard Backlight Timeout"))
                {
                    Local6 = GECI (NSTR)
                    Name (TMPV, One)
                    If ((VSTR == "Never"))
                ...
                ElseIf ((NSTR == "Connected System Recovery"))
                {
                    Local6 = GECI (NSTR)
                    If ((VSTR == "Disable"))
                    {
                ...
                If ((IWOA == One))
                {
                    ...
                    ElseIf ((Local2 == "Keyboard Type"))
                    {
                        ...
                        If ((Zero != \_SB.ERDL))
                        {
                            ...
                            If ((ToInteger (BVAL) == Zero))
                            {
                                Local1 [One] = "*Non-Japanese (Default US), Japanese Keyboard, New EMEA UK KB (US2), New BRZL KB (UK2), New BRZL KB (US3), US4 (LA KB), US5 (Europe KB), US6 (Korea KB), US7 (Brazil KB)"
                                Local1 [0x0A] = "Non-Japanese (Default US)"
                            }
                    ...
                    ElseIf ((Local2 == "Keyboard Backlight Timeout"))
                    {
                        Local6 = GECI (Local2)
                        Local7 = Buffer (0x0400){}
                        \_SB.ECRC (Local6)
                    ...
                    ElseIf ((Local2 == "Connected System Recovery"))
                    {
                        Local6 = GECI (Local2)
                        Local7 = Buffer (0x0400){}
                        \_SB.ECRC (Local6)
            ...
            Method (WQBD, 1, NotSerialized)
            {
                ...
                If ((IWOA == One))
                {
                    ...
                    {
                        LEMP = \_SB.HQEX (0xBA, 0xFD, One, Zero)
                        CreateByteField (LEMP, 0x02, BEMP)
                        Local6 = GECI (Local2)
                        \_SB.ECRC (Local6)
                        If ((Zero != \_SB.ERDL))
                        {
