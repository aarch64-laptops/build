 ...
 *
 * Disassembly of ssdt2.dat, Tue Feb  5 19:29:16 2019
 *
...
DefinitionBlock ("", "SSDT", 2, "HP    ", "84E1", 0x00000001)
{
    ...
    External (_SB_.I2C7.CM90, UnknownObj)
    External (_SB_.I2C7.CM91, UnknownObj)
    External (_SB_.I2C7.CR90, IntObj)
    External (_SB_.I2C7.CR91, UnknownObj)
                ...
                If ((Arg0 == ToUUID ("6f8398c2-7ca4-11e4-ad36-631042b5008f")))
                {
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (One)
                        {
                            ...
                            \_SB.I2C7.CR91 = BUFU /* \_SB_.UBTC.BUFU */
                            BUST = Zero
                            BULN = One
                            BUD1 = 0x08
                            BUD2 = CTL0 /* \_SB_.UBTC.CTL0 */
                            \_SB.I2C7.CM91 = BUFT /* \_SB_.UBTC.BUFT */
                            Release (\_SB.MUT0)
                        }
                        Case (0x02)
                        {
                            ...
                            BULN = One
                            BUD1 = Zero
                            \_SB.I2C7.CM90 = BUFT /* \_SB_.UBTC.BUFT */
                            BUFU = \_SB.I2C7.CR90 /* External reference */
                            Local2 = Zero
                            Local2 |= DerefOf (BUFU [0x06])
                            Local2 |= DerefOf (BUFU [0x07])
                            Local2 |= DerefOf (BUFU [0x08])
                            Local2 |= DerefOf (BUFU [0x09])
                            If ((Local2 == Zero))
                            {
                                Return (One)
                            }
