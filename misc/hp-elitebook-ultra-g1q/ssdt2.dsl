 ...
 *
 * Disassembly of ssdt2.dat, Thu Apr  3 09:47:59 2025
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000D5E4 (54756)
 *     Revision         0x01
 *     Checksum         0xC8
 *     OEM ID           "HPQOEM"
 *     OEM Table ID     "8CBE    "
    ...
    Scope (\_SB)
    {
        ...
        Device (\_SB.WMID)
        {
            ...
            Method (SECV, 4, NotSerialized)
            {
                ...
                {
                    If ((((\_SB.WMID.HF01 & 0x04) == 0x04) || ((\_SB.WMID.HF01 & 
                        0x08) != 0x08)))
                    {
                        HWRC = One
                    }
